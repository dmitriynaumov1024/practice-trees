...
export function createServer (options) {
    ...
    if (options.https) {
        ...
        server = https.createServer(serverOptions, express.app ?? express)
        ...
        server = http.createServer(serverOptions, express.app ?? express)
    }
    let socket = options.websocket? createWebSocket(server) : undefined
    return {
        server: server,
        http: express,
        socket: socket,
